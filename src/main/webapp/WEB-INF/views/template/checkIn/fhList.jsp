...
<script type="text/javascript">
	...
	function flight() {
		...
		var key = "apikey=mXBxI1OLDAM84vgb0gWKYdHXp8rGUWAd" + origin
				+ destination + departure_date + return_date + adults + rest;
		var apiurl = uri + key;
				...
				.getJSON(
						...
						function(data) {
							...
							for (var n = 0; n < i; n++) {
								...
								body.addClass("fbody");
								var f = "<tr><td colspan='1'>항공사명</td><td colspan='1'>"
										+ out_airline
										+ "</td><td colspan='2'><form class='flightform' data-num="+n+"><input type='button' id='f_choose' name='f_choose' class='btn btn-default fchoice' value='선택' />";
								...
								var t = "</form></td> </tr><tr><td class='name'>한국 출발 <input type='hidden' id='f_code' value='1' /></td><td><span class='d_date'>"
										+ f_time[0]
										+ "</span><span class='d_time'><strong>"
										+ f_time[1]
										+ "</strong></span><span class='departure'>"
										+ out_airport
										+ "</span></td> <td><div class='leadTime'>${s_time[0]-f_time[0]}</div></td><td><span class='a_date'>"
										+ s_time[0]
										+ "</span><span class='a_time'><strong>"
										+ s_time[1]
										+ "</strong></span><span class='arrival'>"
										+ fairport
										+ "</span></td></tr><tr><td class='name'>한국 도착 </td> <td><span class='d_date'>"
										+ hf_time[0]
										+ "</span><span class='d_time'><strong>"
										+ hf_time[1]
										+ "</strong></span><span class='departure'>"
										+ gohome_airport
										+ "</span></td><td><div class='leadTime'>${hs_time[0]-hf_time[0]}</div></td><td><span class='a_date'>"
										+ hs_time[0]
										+ "</span><span class='a_time'><strong>"
										+ hs_time[1]
										+ "</strong></span><span class='arrival'>"
										+ home_airport
										+ "</span></td></tr><tr><td>선택 : 성인 ${cvo.people}명/ ${cvo.sitclass}</td><td colspan='2'></td><td>"
										+ price[0] + "원</td></tr></tbody>";
	...
	function hotel() {
		...
		var key = "apikey=mXBxI1OLDAM84vgb0gWKYdHXp8rGUWAd" + location
				+ check_in + check_out + show_sold_out + rest;
		var apiurl2 = uri + key;
		var url = "/checkIn/fdata.do";
						...
						function(data) {
							...
							for (var n = 0; n < i; n++) {
								$(data)
										.each(
												function(i) {
													var price = results[n].total_price.amount
															.split(".");
													var str = "<tr><td class='h_image'>호텔사진</td> <td colspan='2' align='left'><span class='h_name'>"
															+ results[n].property_name
															+ "</span><span class='h_info'><strong>info</strong></span><span class='departure'>주소 : "
															+ results[n].address.line1
															+ "<br />전화번호 : "
															+ results[n].contacts[0].detail
															+ "</span></td> <td>1박 요금<span class='h_price'><strong>"
															+ price[0]
															+ "원</strong></span><span class='findRoom'><form class='hform'><input type='hidden' id='h_name' name='h_name' value='"+results[n].property_name+"'/><input type='hidden' id='h_info' name='h_info' value='info'/><input type='hidden' id='h_address' name='h_address' value='"+results[n].address.line1+"'/><input type='hidden' id='h_tel' name='h_tel' value='"+results[n].contacts[0].detail+"'/><input type='hidden' id='h_price' name='h_price' value='"+price[0]+"'/><input type='hidden' id='h_image' name='h_image' value='image'/><input type='button' class='btn btn-default hchoice'  value='선택'></form></span></td> </tr>"
...
<div id="data">
	<form id="nextForm">
		<input type="hidden" id="flightdata" name="flightdata" /> <input
			type="hidden" id="hoteldata" name="hoteldata" />
	</form>
	<form id="formapiurl">
