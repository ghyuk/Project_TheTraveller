		...
		$.getJSON(url,$("#formapiurl").serialize() , function(data){
			...
			for(var n=0; n<i; n++){
					...
					var home_arrive_time=data.results[n].itineraries[0].inbound.flights[1].arrives_at; 
						...
						var t ="</form></td> </tr><tr><td class='name'>출 국 행<input type='hidden' id='f_code' value='1' /></td><td><span class='d_date'>"+f_time[0]+"</span><span class='d_time'><strong>"+f_time[1]+"</strong></span><span class='departure'>"+out_airport+"</span></td> <td><div class='leadTime'>${s_time[0]-f_time[0]}</div></td><td><span class='a_date'>"+s_time[0]+"</span><span class='a_time'><strong>"+s_time[1]+"</strong></span><span class='arrival'>"+fairport+"</span></td></tr><tr><td class='name'>입 국 행</td> <td><span class='d_date'>"+hf_time[0]+"</span><span class='d_time'><strong>"+hf_time[1]+"</strong></span><span class='departure'>"+gohome_airport+"</span></td><td><div class='leadTime'>${hs_time[0]-hf_time[0]}</div></td><td><span class='a_date'>"+hs_time[0]+"</span><span class='a_time'><strong>"+hs_time[1]+"</strong></span><span class='arrival'>"+home_airport+"</span></td></tr><tr><td>선택 : 성인 ${cvo.people}명/ ${cvo.sitclass}</td><td colspan='2'></td><td>"+price[0]+"원</td></tr></tbody>";
