			    ...
			    <table>
			    		<tr>
			    			<td>
						      ...
						      <label for="departure">출발 도시</label>
						      <input type="text" class="form-control" id="departure" value="서울(인천)">
						    </div>
						</td>
			    			<td>
			    				<div class="form-group">
			    		...
			    		<tr>
			    			<td>
			    				<div class="form-group">
						      <label for="d_date">출국일</label>
						      <input type="text" class="form-control" id="d_date" placeholder="출국일을 선택해주세요">
						    </div>
						</td>
						<td>
			    				<div class="form-group">
						      <label for="a_date">귀국일</label>
						      <input type="text" class="form-control" id="a_date" placeholder="귀국일을 선택해주세요">
						    </div>
						</td>
			    		</tr>
			    		<tr>
