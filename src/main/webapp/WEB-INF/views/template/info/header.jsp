      ...
      <ul class="nav navbar-nav navbar-right">
       ...
       <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="main.do?newyork">Newyork</a></li>
            <li><a href="main.do?melbourne">Melbourne</a></li>
            <li><a href="main.do?madrid">Madrid</a></li>
            <li><a href="main.do?osaka">Osaka</a></li>
          </ul>
        </li>
